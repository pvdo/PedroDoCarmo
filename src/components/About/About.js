            ...
            <div className="margin-bottom">
                ...
                <div className="container text-center">
                    ...
                    <div className="centeredA ">
                        <p className="pA">
                            I am a Front-end developer with experience in web
                            applications. My competencies include JavaScript,
                            React, CSS. I am experienced working with
                            Express.js, Node.js, and MongoDB.
                            <br />
                            Also comfortable working with: C++, Java, MySQL.
                        </p>
                        <Image
                            fluid
                            className="fixed-"
                    ...
                    <a href={resumePdf} target="_blank" rel="noreferrer">
                        <div className="resumeLink">
                            <span>TAKE A LOOK AT MY RESUME!</span>
                        </div>
                    </a>
                </div>
